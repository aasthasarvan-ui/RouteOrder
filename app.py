...
# --- AUTOMATIC BACKGROUND PRE-PROCESSING HOOK FOR MULTIPLE FILES ---
processed_uploaded_inputs = []
if uploaded_inputs:
    try:
        mapping_dict = {}
        ...
        for uploaded_file in uploaded_inputs:
            if uploaded_file.name.lower() == "output.xlsx":
                processed_uploaded_inputs.append(uploaded_file)
                continue
            ...
            if f_row != -1:
                ...
                wb_mod.save(mod_buf)
                mod_buf.seek(0)
                uploaded_file.getvalue = lambda: mod_buf.getvalue()
            
            processed_uploaded_inputs.append(uploaded_file)
        
        uploaded_inputs = processed_uploaded_inputs
    except Exception as e:
        pass
