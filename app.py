            ...
            try:
                ...
                for uploaded_file in uploaded_inputs:
                    ...
                    for r in range(fg_row + 1, df_input.shape[0]):
                        ...
                        # Agar quantity 0 ya blank hai, toh row ko completely skip karo (no output, no unmapped alert)
                        ...
                        # Agar quantity > 0 hai aur STILL DR Code nahi mila, tabhi unmapped ledger aur alert mein aayega!
                        if not has_dr_code:
        ...
        if st.button("📧 Email"):
            if email_user and email_pass and recipient_email:
                try:
                    ...
                    unmapped_email_html = ""
                    if st.session_state.unmapped_current_batch:
                        unmapped_email_html = "<h3 style='color: #dc2626;'>⚠️ Unmapped Missing DRs (Fallback Generated):</h3><ul>"
